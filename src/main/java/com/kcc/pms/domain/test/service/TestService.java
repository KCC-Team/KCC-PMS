...
public interface TestService {
    ...
    Long saveTest(Long memberNo, Long prjNo, TestMasterRequestDto testReq);
    TestMasterRequestDto getTestDetail(Long testNo);
    void updateTest(TestMasterRequestDto testReq);
