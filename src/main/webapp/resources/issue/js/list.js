...
function initFirstGrid(){
    return new Promise((resolve) => {
        ...
        firstGrid.setConfig({
            ...
            columns: [
                {key: "riskTitle", label: "이슈명", align: "left", width: 200, formatter: function() {
                        var title = this.value;
                        return '<a href="/projects/issueInfo?no=' + encodeURIComponent(this.item.riskNo) + '" class="danger-title" style="color: #0044cc; font-size: 13px; font-weight: bold; text-decoration: none;">' + title + '</a>';
                    }},
                ...
                {key: "className", label: "이슈구분", width: 190, align: "center", formatter: function (){
...
$('.danger-export-excel').click(function (e) {
    e.preventDefault();
    $.ajax({
        url: '/projects/risks/excel?typeCode=PMS00301',
        type: 'GET',
        xhrFields: {
