$(document.body).ready(function () {
    ...
    firstGrid.setConfig({
        ...
        columns: [
            {key: "title", label: "이슈명", align: "center", width: 295, formatter: function() {
            ...
            {key: "type", label: "이슈구분", width: 180, align: "center", formatter: function (){
            ...
            {key: "register", label: "발견자", width: 170, align: "center", formatter: function (){
                    return '<span style="font-size: 13px;">' + this.value + '</span>';
                }},
